        ...
        {Object.entries(modulesByCategory).map(([category, modules]) => (
          <div key={category} className="category-section">
            ...
            <div className="modules-grid">
              {modules.map((module) => (
                <div key={module.id} className={`module-card ${module.tier}`}>
                  ...
                  <div className="module-footer">
                    ...
                    {module.tier === 'locked' && <span className="tier-badge locked">Premium</span>}
                  </div>
                  <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank" rel="noopener noreferrer" className="module-video-link">
                    Watch Tutorial
                  </a>
                </div>
              ))}
